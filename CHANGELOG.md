...
* feat: Add support for AWS Lambda Managed Instances (#98) @ergousha

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-lambda/compare/v4.0.0...v4.1.0
...
* feature: add support for durable functions (#99) @wvanheerde

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-lambda/compare/v3.0.0...v4.0.0
